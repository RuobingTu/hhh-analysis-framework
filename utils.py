...
# Optimized non-uniform bin edges for limit extraction (ProbHHH4b2tau).
# Generated by optimize_binning.py: greedy merge + local search maximizing
# total Asimov Z = sqrt(sum Z_i^2) with signal x1000 scaling.
# All bins satisfy min background >= 0.3 (safe for AutoMCStats(10)).
# Categories not listed here use the default uniform binning from histograms_dict.
category_binning_overrides = {
    "ProbHHH4b2tau_3Higgs_sum_2tau0l": [0.000, 0.492, 0.896, 0.956, 0.976, 0.984, 0.992, 1.000],
    "ProbHHH4b2tau_3Higgs_sum_1tau1l": [0.000, 0.828, 0.916, 0.956, 0.972, 0.980, 0.984, 0.988, 0.992, 0.996, 1.000],
    "ProbHHH4b2tau_3Higgs_sum_0tau2l": [0.000, 0.776, 0.876, 0.932, 0.960, 0.984, 0.988, 1.000],
    "ProbHHH4b2tau_2Higgs_sum_2tau0l": [0.000, 0.908, 0.944, 0.972, 0.976, 0.980, 0.984, 0.988, 0.992, 1.000],
    "ProbHHH4b2tau_2Higgs_sum_1tau1l": [0.000, 0.796, 0.920, 0.964, 0.972, 0.980, 0.984, 0.988, 0.992, 0.996, 1.000],
    "ProbHHH4b2tau_2Higgs_sum_1tau0l": [0.000, 0.740, 0.864, 0.912, 0.944, 0.960, 0.980, 0.984, 0.988, 1.000],
    "ProbHHH4b2tau_2Higgs_sum_0tau2l": [0.000, 0.776, 0.900, 0.952, 0.984, 1.000],
}
